...
# new_response = requests.get(url2, cookies=response.cookies)
# print(f'check user session - {new_response.json()}')
data3 = {
    'page': 1,
    'per_page': 10,
    'cargo_type': 3,
...
response = requests.post(url3, data=json.dumps(data3))
# answer = response.get("replies")
print(f'register user - {response.json()}')
print(response)


response = requests.post(url3, data=json.dumps(data3), cookies=response.cookies)
# answer = response.get("replies")
print(f'register user 2 - {response.json()}')
print(response)
